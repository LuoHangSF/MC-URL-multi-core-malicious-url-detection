...
def batch_vote_test(test_csv_path, weights):
    # 加载模型一次（全局已加载，无需重复加载）
    ...
    # 权重
    # weights = {"bayes": 1, "ada": 2, "rf": 3, "dt": 1, "lgs": 1, "gbc": 3, "tf_idf": 2, "URLGledac": 0}
    # weights = {"bayes": 0.10688769814690781, "ada": 0.12483255190890824, "rf": 0.13190723375753519, "dt": 0.1257814244250949, "lgs": 0.11729738780977898, "gbc": 0.13126534940835008, "tf_idf": 0.13012112078588972, "URLGledac": 0.13190723375753519}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_model', choices=["bayes", "ada", "rf", "dt", "lgs", "gbc", "tf_idf", "URLGledac", "all_old", "all_mean", "all_weighted"], help='select a model to test or test the 8 model', default='all_weighted')    
    args = parser.parse_args()
    # batch_vote_test("./data/merged_test.csv")
    
    if args.test_model == 'bayes':
        print("Testing Bayes model...")
        weights = {"bayes": 1, "ada": 0, "rf": 0, "dt": 0, "lgs": 0, "gbc": 0, "tf_idf": 0, "URLGledac": 0}
    elif args.test_model == 'ada':
        print("Testing AdaBoost model...")
        weights = {"bayes": 0, "ada": 1, "rf": 0, "dt": 0, "lgs": 0, "gbc": 0, "tf_idf": 0, "URLGledac": 0}
    elif args.test_model == 'rf':
        print("Testing Random Forest model...")
        weights = {"bayes": 0, "ada": 0, "rf": 1, "dt": 0, "lgs": 0, "gbc": 0, "tf_idf": 0, "URLGledac": 0}
    elif args.test_model == 'dt':
        print("Testing Decision Tree model...")
        weights = {"bayes": 0, "ada": 0, "rf": 0, "dt": 1, "lgs": 0, "gbc": 0, "tf_idf": 0, "URLGledac": 0}
    elif args.test_model == 'lgs':
        print("Testing Logistic Regression model...")
        weights = {"bayes": 0, "ada": 0, "rf": 0, "dt": 0, "lgs": 1, "gbc": 0, "tf_idf": 0, "URLGledac": 0}
    elif args.test_model == 'gbc':
        print("Testing Gradient Boosting model...")
        weights = {"bayes": 0, "ada": 0, "rf": 0, "dt": 0, "lgs": 0, "gbc": 1, "tf_idf": 0, "URLGledac": 0}
    elif args.test_model == 'tf_idf':
        print("Testing TF-IDF model...")
        weights = {"bayes": 0, "ada": 0, "rf": 0, "dt": 0, "lgs": 0, "gbc": 0, "tf_idf": 1, "URLGledac": 0}
    elif args.test_model == 'URLGledac':
        print("Testing URLGledac model...")
        weights = {"bayes": 0, "ada": 0, "rf": 0, "dt": 0, "lgs": 0, "gbc": 0, "tf_idf": 0, "URLGledac": 1}
    elif args.test_model == 'all_weighted':
        print("Testing all models with weighted voting...")
        weights = {"bayes": 0.10688769814690781, "ada": 0.12483255190890824, "rf": 0.13190723375753519, "dt": 0.1257814244250949, "lgs": 0.11729738780977898, "gbc": 0.13126534940835008, "tf_idf": 0.13012112078588972, "URLGledac": 0.13190723375753519}
    elif args.test_model == 'all_old':
        print("Testing all models with old MC-URL weights...")
        weights = {"bayes": 1, "ada": 2, "rf": 3, "dt": 1, "lgs": 1, "gbc": 3, "tf_idf": 2, "URLGledac": 0}
    elif args.test_model == 'all_mean':
        print("Testing all models with equal weights...")
        weights = {"bayes": 1, "ada": 1, "rf": 1, "dt": 1, "lgs": 1, "gbc": 1, "tf_idf": 1, "URLGledac": 1}
        
    batch_vote_test("./data/merged_test.csv", weights=weights)