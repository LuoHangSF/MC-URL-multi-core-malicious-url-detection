...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', choices=['train', 'test'], help='train or test', default='test')    
    ...
    if args.mode == 'train':
        ...
        use_sklearn.eval_six_models(x_test, y_test)
    else:
    ...
    # except:
    #     x_fish = pd.read_csv("fishtank_features")
    # x_fish['URL'] = 'fish.com'
    # x_fish['label'] = 1
    # y_fish = x_fish['label']
